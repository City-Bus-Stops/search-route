    ...
    <div className="pusher">
        ...
        <div className="ui middle aligned stackable grid container">
          <div className="row">
            ...
            <div className="six wide right floated column">
              <img
                alt="white"
                src="http://semantic-ui.com/examples/assets/images/wireframe/white-image.png"
      ...
      <div className="ui vertical stripe quote segment">
        <div className="ui equal width stackable internally celled grid">
          <div className="center aligned row">
            ...
            <div className="column">
              <h3>I should not have gone with their competitor.</h3>
              <p>
                <img
                  alt="avatar"
                  src="http://semantic-ui.com/examples/assets/images/avatar/nan.jpg"
      ...
      <div className="ui vertical stripe segment">
        <div className="ui text container">
          ...
          <p>Instead of focusing on content creation and hard work,
            we have learned how to master the art of doing
            nothing by providing massive amounts of whitespace and
            generic content that can seem massive, monolithic and
          ...
          <p>Yes I know you probably disregarded the earlier boasts
          ...
          <a className="ui large button">I am Still Quite Interested</a>
        </div>
      </div>
